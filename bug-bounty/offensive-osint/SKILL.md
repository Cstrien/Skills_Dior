...
| `cms-fingerprints.md` | CMS detection signatures (Craft, WordPress, Drupal, Joomla, Ghost, ExpressionEngine, Statamic, October), CMS-specific probe paths, Cloudflare challenge bypass for CMS recon, S3 bucket discovery via asset subdomains, CMS-to-cloud pivot table | craft cms fingerprint, wordpress probe paths, drupal detection, joomla admin, ghost api, cms recon, cloudflare challenge bypass, s3 bucket discovery, assets subdomain, cms cloud pivot |
